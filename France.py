...
class Ui_AviateNEducate(object):
    ...
    def loaduni(self, text):
        if text == "University of Paris":
            ...
            self.CountryPicLabel.setPixmap(QtGui.QPixmap(_fromUtf8("Images\FranceImages\FranceMain.jpg")))
            self.CountryPicLabel.setObjectName(_fromUtf8("France"))
            self.Student1PicLabel.setPixmap(QtGui.QPixmap(_fromUtf8("Images\FranceImages\FranceS1.jpg")))
            self.Student1PicLabel.setObjectName(_fromUtf8("p1"))
            self.Student2PicLabel.setPixmap(QtGui.QPixmap(_fromUtf8("Images\FranceImages\FranceS2.jpg")))
            self.Student2PicLabel.setObjectName(_fromUtf8("p2"))
            self.Student3PicLabel.setPixmap(QtGui.QPixmap(_fromUtf8("Images\FranceImages\FranceS3.jpg")))
        ...
        if text == "University of Lyon":
            ...
            self.CountryPicLabel.setPixmap(QtGui.QPixmap(_fromUtf8("Images\FranceImages\FranceMain.jpg")))
            self.CountryPicLabel.setObjectName(_fromUtf8("France"))
            self.Student1PicLabel.setPixmap(QtGui.QPixmap(_fromUtf8("Images\FranceImages\FranceS3.jpg")))
            self.Student1PicLabel.setObjectName(_fromUtf8("p4"))
            self.Student2PicLabel.setPixmap(QtGui.QPixmap(_fromUtf8("Images\FranceImages\FranceS1.jpg")))
            self.Student2PicLabel.setObjectName(_fromUtf8("p5"))
            self.Student3PicLabel.setPixmap(QtGui.QPixmap(_fromUtf8("Images\FranceImages\FranceS2.jpg")))
