...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        font.setFamily(_fromUtf8("Verdana"))
        font.setPointSize(10)
        self.aboutBtn.setStyleSheet("background-color: grey")
        ...
        font.setFamily(_fromUtf8("Verdana"))
        font.setPointSize(10)
        self.helpBtn.setStyleSheet("background-color: grey")
        ...
        self.verticalLayoutWidget_3.setStyleSheet("background-color:  #f2f2f2") #remove from here if any issues occur
        self.AboutTextBrowser.setObjectName(_fromUtf8("AboutTextBrowser"))
        self.AboutTextBrowser.insertPlainText("Welcome to AviateNEducate, a portal designed for students by students to make the challenge of studying abroad more simple and achievable."
                                              "\n\n\nSelect your country of choice above to be connected to our portal, here you will find information on accommodation, "
                                              "funding and the universities in that country with relevant courses to facilitate your study. "
                                              "\n\n\nIf you need any help with our features, please select “Help” button.")
